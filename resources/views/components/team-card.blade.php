<div class="card bg-transparent border-0 text-center">
    <div class="card-img">
        ...
        @endif
        @if ($member->fb_url !='' || $member->tw_url !='' || $member->ins_url !='')
        <ul class="card-social list-inline">
            ...
            @endif
            @if ($member->ins_url !='')
            <li class="list-inline-item"><a class="instagram" target="_blank" href="{{ $member->ins_url }}"><i class="fab fa-instagram"></i></a>
            </li>
            @endif
        </ul>
        @endif
